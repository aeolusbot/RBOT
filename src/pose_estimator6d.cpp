...
PoseEstimator6D::PoseEstimator6D(const std::string shader_folder, int width, int height, float zNear, float zFar, const cv::Matx33f &K, const cv::Matx14f &distCoeffs, vector<Object3D*> &objects)
{
    ...
    renderingEngine->init(shader_folder, K, width, height, zNear, zFar, 4);

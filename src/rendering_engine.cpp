...
void RenderingEngine::init(const std::string& shader_folder, const Matx33f& K, int width, int height, float zNear, float zFar, int numLevels)
{
    this->width = width;
    this->height = height;
    ...
    shaderFolder = QString::fromStdString(shader_folder + "/");
